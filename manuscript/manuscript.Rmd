...
A simple way to capture this behavior computationally is with satisficing learning (Crandall and goodrich 2008).
...
droughts <-   c(runif(40) < 0.2, runif(20) < 0.4, runif(40) < 0.2)
```
